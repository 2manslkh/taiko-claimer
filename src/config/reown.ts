...
import { mainnet, arbitrum } from '@reown/appkit/networks'; // Using mainnet and arbitrum as per reown-appkit.mdc
...
export const networks: [Chain, ...Chain[]] = [mainnet, arbitrum]; // As per reown-appkit.mdc
